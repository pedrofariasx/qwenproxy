...
test('Concurrent chat requests check for "chat is in progress"', { skip: process.env.RUN_LIVE_QWEN_TESTS === 'true' ? false : 'Requires live Qwen session; set RUN_LIVE_QWEN_TESTS=true to run' }, async () => {
